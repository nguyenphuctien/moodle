...
M.form_dndupload.init = function(Y, options) {
    var dnduploadhelper = {
        ...
        init_events: function() {
            ...
            // We should update the attachment UI when we drag enter other draggable zones.
            this.Y.on('dragenter', this.drag_enter_other_zones, 'div.editor_atto', this);
            this.Y.on('dragleave', this.drag_leave_other_zones, 'div.editor_atto', this);
        ...
        /**
         * Handle a dragleave event, remove the highlight if dragged enter the other draggable zones.
         * node
         */
        drag_enter_other_zones: function() {
            this.inOtherDragZone = true;
            this.hide_drop_target();

        },

        /**
         * Handle a dragleave event, add the highlight if dragged leave other draggable zones.
         * node
         */
        drag_leave_other_zones: function() {
            this.inOtherDragZone = false;
            this.show_drop_target();
        },
