...
$string['assessment_phase:mail:subject'] = 'You have {$a->total} assigned submission(s) to assess on {$a->workshopname}';
$string['assessment_phase:mail:html'] = 'You have an assigned submission to assess on {$a->workshopname}';
...
$string['customemail_help'] = 'You can enter specific email addresses here if you wish. For example, you may use a team inbox to monitor the Workshop progress. If you need to add more than one email address, simply separate them using a comma.';
...
$string['emailclosedate'] = 'This phase closes at: {$a}.';
$string['emailnotification'] = 'The {$a->courseshortname} {$a->coursefullname} {$a->workshopname} has moved from the {$a->oldphase} phase to the {$a->newphase} phase.';
$string['emailsalutation'] = 'Dear {$a},';
$string['emailopendate'] = 'This phase opens at: {$a}.';
$string['emailworkshoplink'] = 'The Workshop activity can be accessed at: {$a}';
...
$string['messageprovider:phasechanged'] = 'Phase changed notification';
...
$string['phasechangenotification'] = 'Phase-change notifications';
$string['phasechangenotification_help'] = 'You can set notifications to be sent to particular roles every time Workshop changes phase; select the required role under each phase. Note that you can also set custom email addresses.';
